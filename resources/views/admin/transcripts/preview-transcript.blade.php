                        ...
                        <div class="card">
                          <div class="card-header">
                            <div class="row no-print">
                              <div class="col-12"> 
                                <a href="{{ route('publishExaminationResults', [$exam->id])}}" onclick="return confirm('Are you sure you want to publish examination results?')" class="btn btn-warning float-left">
                                    Publish examination results
                                  <a href="{{ route('examinations')}}" class="btn btn-danger float-right"> BACK
                                </a> 
                              </div>
                            </div>
                          </div>
