                                        ...
                                        <form action="{{ route('saveGrade')}}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="name" class="form-control" placeholder="Grade name (i.e A, B+, B, C, etc..)" />
                                                    @error('name')
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="markFrom" class="form-control" placeholder="Enter grade marks from" />
                                                    @error('markFrom')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="markupTo" class="form-control" placeholder="Enter grade marks up to" />
                                                    @error('markupTo')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
